  ...
  return (
    ...
    >
      ...
      <div className="flex-1 max-w-sm">
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-9 rounded-lg pl-10 pr-4 text-sm border-none focus:ring-2"
            style={{
      ...
      <div className="flex items-center gap-2">
        ...
        {/* New Analysis */}
        <button
          className="flex items-center gap-2 h-9 px-4 rounded-lg text-sm font-semibold transition-opacity hover:opacity-85"
          style={{
