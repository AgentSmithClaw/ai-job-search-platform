      ...
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 xl:px-10 pb-14 md:pb-20">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  size="lg"
                  variant="secondary"
                  icon={isAuthenticated ? 'space_dashboard' : 'login'}
        ...
        <section className="mt-16 md:mt-24">
          <div className="max-w-[760px]">
            ...
            <h2 className="text-[34px] md:text-[52px] leading-[1.02] font-black tracking-[-0.04em]">
              Everything you need from analysis to action.
            </h2>
            <p className="mt-4 text-base md:text-lg leading-7" style={{ color: 'var(--color-text-secondary)' }}>
              GapPilot keeps resume diagnosis, application tracking, learning tasks, and interview prep in one connected workflow so each analysis turns into concrete next steps.
            </p>
          </div>
        ...
        <section className="mt-16 md:mt-24 grid grid-cols-1 xl:grid-cols-[0.9fr_1.1fr] gap-6 md:gap-8 items-start">
          <div>
            ...
            <h2 className="text-[34px] md:text-[52px] leading-[1.02] font-black tracking-[-0.04em]">
              A simple workflow from analysis to execution.
            </h2>
            <p className="mt-4 text-base md:text-lg leading-7 max-w-[620px]" style={{ color: 'var(--color-text-secondary)' }}>
              Start with your resume and the target JD, review a structured report, then move directly into tasks, applications, and interview preparation.
            </p>
          </div>
